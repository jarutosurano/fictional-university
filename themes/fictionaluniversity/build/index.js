...
class Search {
  ...
  constructor() {
    ...
    this.resultsDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__results"); // Container for search results
    this.openButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger"); // Button to open search overlay
    this.closeButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay__close"); // Button to close search overlay
    this.searchOverlay = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay"); // The search overlay element
    this.searchField = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-term"); // Input field for search queries
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().when(jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityLocalize.root_url + '/wp-json/wp/v2/posts?search=' + this.searchField.val()), jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityLocalize.root_url + '/wp-json/wp/v2/pages?search=' + this.searchField.val())).then((posts, pages) => {
  ...
  openOverlay() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").addClass("body-no-scroll"); // Prevent body scrolling
  ...
  closeOverlay() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").removeClass("body-no-scroll"); // Enable body scrolling
