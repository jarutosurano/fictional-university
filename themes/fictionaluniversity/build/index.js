...
class Search {
  ...
  constructor() {
    ...
    this.openButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger"); // Element that triggers the search overlay
    this.closeButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay__close"); // Element that closes the search overlay
  ...
  openOverlay() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").addClass("body-no-scroll"); // Prevent scrolling when overlay is active
  ...
  closeOverlay() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").removeClass("body-no-scroll"); // Allow scrolling when overlay is closed
